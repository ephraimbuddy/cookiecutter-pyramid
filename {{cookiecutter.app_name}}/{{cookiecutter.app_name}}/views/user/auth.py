...
@view_config(route_name='registration',
             renderer='{{ cookiecutter.app_name }}:templates/user/registration.{{ "pt" if "chameleon" == cookiecutter.template_language else cookiecutter.template_language }}')
...
@view_config(route_name="login",
             renderer='{{ cookiecutter.app_name }}:templates/user/login.{{ "pt" if "chameleon" == cookiecutter.template_language else cookiecutter.template_language }}')
def login(request):
    if request.user:
